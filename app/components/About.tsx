...
const imagestwo = ["/images/shater-6.png", "/images/shater-7.png", "/images/shater-8.png", "/images/shater-9.png"];
            ...
            <main className={`pt-16`}>
              ...
              <div className="relative">
                ...
                <p className="text-[#464229] f-satoshi text-base mt-6 mb-6 slide-two">
                  In a galaxy not so far away, a world cluttered with bad UX, clunky flows, and uninspired interfaces,
                  one designer emerges to bring balance. From the fintech frontlines to the SaaS battlegrounds, he’s
                  conquered e-commerce kingdoms and woven design systems worthy of legend.
                  <br />
                  <br />
                  This is his story.
                  <br />
                  <br />
                  With a stylus in one hand and a love for God, anime, sports tactics, and music in the other, he crafts
                  products that don’t just work—they resonate. Each pixel tells a story. Each flow is a journey.
                  <br />
                  <br />
                  But the fight is never over. With startups calling for guidance and users demanding clarity, the
                  designer never rests. The mission is clear: to protect the user experience, to innovate, and to
                  inspire.
                  <br />
                  <br />
                  He is not just any product designer. He is our last hope.
                </p>
              ...
              <div className="pt-14">
                <p className="f-p22 text-[32px] leading-8 text-[#19170E]">
                  ...
                  <span className="slide-two ml-1 f-p22Italic text-base text-[#B1AFA4]">or dont</span>
                </p>
                {/* mobile photo */}
                  ...
                  <div className="hidden w-[610px] overflow-hidden">
                    ...
                    <div className=" flex gap-[10px] w-[680px] whitespace-nowrap">
                      {images.map((src, index) => (
                        <div key={index} className={`relative w-[160px] h-[250px] ${index === 0 ? "w-[100px]" : ""}`}>
                          <Image
                            className={`rounded-2xl ${index === 0 ? "rounded-l-none" : ""}`}
                            src={src}
                            alt={`Image ${index + 1}`}
                            layout="fill"
                  ...
                  <div className="relative overflow-hidden w-full h-[250px]">
                    ...
                    <div className="flex gap-[10px] animate-scroll">
                      {[...images, ...images, ...images, ...images].map((src, index) => (
                        <div key={index} className="relative w-[160px] h-[250px] flex-shrink-0">
                          <Image
                            className="rounded-2xl"
                            src={src}
                            alt={`Image ${index + 1}`}
              ...
              <div className="pt-14 ">
                ...
                <div className="pt-5 text-[#232323] f-satoshi-medium text-base">
                  ...
                  <p className="slide-two pt-8 min-[390px]:w-[342px] md:w-auto">
                    I make <span className="f-satoshi-bold">AMAZING</span> playlists, follow me on{" "}
                    <Link
                  ...
                  <div className="flex items-center pt-8">
                    <div className="md:w-[464px]">
                      <p className="slide-two ">
                        I&apos;m currently on Episode 700 of One Piece! I also own a number of anime figures.
                      </p>
    ...
    >
      ...
      />
                  ...
                  <p className="slide-two py-8">
                    I&apos;ve been using xbox for over 15 years, I currently use a series S
                  </p>
                  {/* fav sports man */}
                  ...
                  {/* music taste */}
                  <div className="pb-8">
                    <p className="text-[#232323]">5 Artists to explain my music taste</p>
                    <div className="slide-two flex flex-wrap gap-3 pt-2">
                      {musicArtist.map(item => (
                        <Link className="text-[#19170E]" key={item.title} href={item.link}>
                          {item.title}
                          <Arrow alt={item.title} />
                        </Link>
                      ))}
                  ...
                  {/* books */}
                  <div className="pb-8">
                    <p className=" text-[#232323]">I read a little and these are my favourite books;</p>
                    <div className="slide-two flex flex-wrap gap-3 pt-2">
                      {books.map(item => (
                        <Link className="text-[#19170E]" key={item.title} href={item.link}>
                          {item.title}
