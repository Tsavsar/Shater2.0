...
const About = () => {
	...
	return (
		...
		<div className="blur-overlay" /> {/* Fixed blur overlay */}
			...
			<p
			 data-blur 
				className="f-satoshi text-base text-[#464229] pt-5 pb-10">
				Alright, let’s do this one last time...... My name is Shater D. Tsavsar.
			</p>
			{/* section - name pronun */}
			<div
				
				className="f-satoshi md:flex justify-between items-center">
				<p data-blur className="text-[#19170E] text-3xl min-[375px]:text-[2.5rem] md:text-[3.35rem] leading-[60px] md:leading-[78px]">
					/ˈʃɑː-teɪ/ /ˈtɑːv-sɑː/{' '}
				</p>
        <div data-blur >
				<PlayName />
			...
			<div className=" pt-6 f-satoshi text-[#464229] text-base">
				<p >
				<span data-blur>	And for the last couple of years I&apos;ve been the one and only pixel
			pushing, Jesus loving, sports </span> analysing, anime power scaling, friendly 
				<span data-blur>	neighbourhood{' '}</span>
					<span data-blur className="comic-neue-regular line-through text-[#46422966]">
						Spider-Man
					</span>{' '}
					<span data-blur>Product Designer.</span>
				</p>
				<p data-blur className="py-5">
