export const projectsData = [
  ...
  },
  {
    ...
    images: ['/images/weave/desktop.png', '/images/weave/desktop-2.png', '/images/weave/mock.png'],
    mobile: true,
    laptop: true,
    caseStudy: true,
  ...
  },
  {
    ...
    images: ['/images/brew-time/desktop.png', '/images/brew-time/desktop-2.png', '/images/brew-time/mobile-1.png', '/images/brew-time/mobile-2.png', '/images/brew-time/mobile-3.png', '/images/brew-time/mobile-4.png'],
    mobile: false,
    laptop: true,
    caseStudy: true,
